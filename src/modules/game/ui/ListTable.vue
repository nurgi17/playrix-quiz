    ...
    <div class="flex flex-col gap-5 pt-[40px]">
      <div class="flex flex-row gap-5" v-for="category in categories" :key="category.id">
        ...
        <div v-for="point in category.points" :key="point.id">
          <div
            class="flex items-center justify-center text-center w-[159px] h-[117px] text-[#000000] font-bold text-[40px] uppercase hover:bg-[#FFDE00] active:bg-[#FFDE00] rounded-[6px] cursor-pointer"
